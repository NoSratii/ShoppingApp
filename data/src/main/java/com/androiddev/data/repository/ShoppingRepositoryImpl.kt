...
class ShoppingRepositoryImpl @Inject constructor() : ShoppingRepository {
    ...
    private val remoteDataSource = (1..100).map {
        ShoppingEntity.ShoppingItem(
            titleId = "کودک و نوزاد",
            subTitleId = "اسباب بازی کودک",
            icon = "https://api.snapp.market/media/cache/product-variation_image_thumbnail/uploads/images/vendors/users/app/336724.jpg",
            hasOff = false,
            price = 47000.0,
            desc = "اسباب بازی لودر سیبیلو آفرود ۲ رادا تویز",
        )
    }
